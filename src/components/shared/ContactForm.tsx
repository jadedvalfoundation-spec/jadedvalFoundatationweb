  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl p-6 sm:p-8" style={{ background: "#0f1e2a", border: "1px solid rgba(255,255,255,0.08)" }}>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-400">Full Name</label>
          <input
            required
            value={form.name}
        ...
        <div>
          <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-400">Email Address</label>
          <input
            type="email"
            required
            value={form.email}
      ...
      <div className="mt-4">
        <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-400">Subject</label>
        <input
          value={form.subject}
      ...
      <div className="mt-4">
        <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-400">Message</label>
        <textarea
          required
          rows={5}
          value={form.message}
      ...
      <button
        ...
        className="mt-5 w-full rounded-full bg-brand py-3 text-sm font-bold uppercase tracking-widest text-white transition hover:bg-brand-dark disabled:opacity-60"
      >
